...
class _EventState extends State<Event> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: internet == 0
              ? NoInternetScreen(notifyParent: refresh)
                        ...
                        return Container(
                          child: Column(
                            ...
                            children: <Widget>[
                              SizedBox(
                                height: UIUtility()
                                    .getProportionalHeight(height: 4),
                              ),
                              Divider(
                                thickness: 3,
                                color: Colors.grey.withOpacity(0.8),
                                indent: UIUtility()
                                    .getProportionalWidth(width: 165),
                                endIndent: UIUtility()
                                    .getProportionalWidth(width: 165),
                              ),
                              Row(
                              ...
                              SizedBox(
                                height: UIUtility()
                                    .getProportionalHeight(height: 10),
                              ),
                            ],
                          ),
                        );
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize:
                                UIUtility().getProportionalWidth(width: 16)),
                      ),
                      Text(
                        getTime(),
                        style: TextStyle(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Icon(Icons.place,
                                size:
                                    UIUtility().getProportionalWidth(width: 30),
                ...
                widget.currEvent.event_name != null
                    ? Column(
                        children: <Widget>[
                          SizedBox(
                            height:
                                UIUtility().getProportionalHeight(height: 4),
                          ),
                          Container(
                              margin:
                                  EdgeInsets.only(left: 8, right: 8, top: 4),
                              child: AutoSizeText(
                                widget.currEvent.event_name.toUpperCase(),
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Divider(
                            thickness: 1,
                            endIndent:
                                UIUtility().getProportionalWidth(width: 5),
                                                                  ...
                                                                  Text(
                                                                    ...
                                                                    style: TextStyle(
                                                                        color: Colors
                                                                            .black54,
                                                                        fontSize:
                                                                            UIUtility().getProportionalWidth(width: 15)),
                                                                  ),
                                                                ],
                                                              ),
                                                            ],
                                                                  ...
                                                                  borderRadius:
                                                                      BorderRadius.all(
                                                                          Radius.circular(
                                                                              10)),
                                                                  child: Container(
                                                                      width: UIUtility().getProportionalWidth(
                                                                          width:
                                                                              120),
                                                                      height: UIUtility().getProportionalWidth(
                                                                          width:
                                                                              120),
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          border: Border.all(
                                                                              color: ColorGlobal.blueColor.withOpacity(
                                                                                  0.5),
                                                                              width:
                                                                                  2)),
                                                                      child: Image.network(
                                                              ...
                                                              child: snapshot
                                                                  ...
                                                                  ? InkWell(
                                                                      child: Image
                                                                          .network(
                                                                        (Api.imageUrl +
                                                                            snapshot.data[index].brochure.toString()),
                                                                        fit: BoxFit
                                                                            .cover,
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => EventPictureDisplay(Api.imageUrl + snapshot.data[index].brochure.toString())))
                                                                      },
                                                                    )
                                                                  : Container(
                                                                      height: UIUtility().getProportionalHeight(
                                                                          height:
                                                                              300),
                                                                      color: Color(
                                                                          0xff4a4a4d),
                                                                ...
                                                                child: Text(
                                                                  ...
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  style: TextStyle(
                                                                      fontSize: UIUtility().getProportionalWidth(
                                                                          width:
                                                                              15),
                                                                      fontWeight:
                                                                          FontWeight
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          style:
                                                                              TextStyle(fontSize: UIUtility().getProportionalWidth(width: 15)),
                                                                          maxLines:
                                                                              1,
                                                                        ),
                                                                      ),
            ...
            SizedBox(
                height: widget.isCompleted != true
                    ? 100
                    : UIUtility().getProportionalHeight(height: 0)),
          ],
        ),
      );
  ...
  Future<List<SocialMediaFeed>> getSocialMediaLinks() async {
    ...
    uri =
        uri.replace(query: "event_id=" + widget.currEvent.event_id.toString());
  ...
  void initState() {
    ...
    getEventDetails();
    if (widget.currEvent.event_description != "" &&
        widget.currEvent.event_description.length > 200) {
      firstHalf = widget.currEvent.event_description.substring(0, 200);
      secondHalf = widget.currEvent.event_description
          .substring(200, widget.currEvent.event_description.length);
    } else {
    ...
    if (iconLocation != null) {
      return InkWell(
        child: Container(
          ...
          child: Image(
            height: UIUtility().getProportionalHeight(height: 26),
            width: UIUtility().getProportionalWidth(width: 26),
          ...
          if (responseBody.data.length != 0) {
            setState(() {
              detailsInfo = EventDetailsInfo(
                  detail_amendment_message:
                      responseBody.data['detail_amendment_message'],
  ...
  Future<List<String>> getEventFile(String file_type) async {
    ...
    String url = Api.getFile +
        "?event_id=" +
        widget.currEvent.event_id.toString() +
        "&file_type=" +
        file_type;
            ...
            setState(() {
              if (file_type == "flyer") {
                if (responseBody.data['file'] != null) {
                  ...
                  flyerUrl =
                      Api.imageUrl + responseBody.data['file'].toString();
                }
