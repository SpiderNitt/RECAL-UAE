    ...
    return Center(
      child: Text(
        ...
        style: GoogleFonts.josefinSans(
            fontSize: UIUtility().getProportionalWidth(width: 22, choice: 1),
                ...
                child: AnimatedList(
                    ...
                    itemBuilder: (BuildContext context, int index, animation) {
                      return SizeTransition(
                        child: VolunteerCard(eventList[index], true,
                            widget.status, attended.elementAt(index)),
