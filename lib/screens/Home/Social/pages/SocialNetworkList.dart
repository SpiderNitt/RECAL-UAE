...
class _MemberDatabaseState extends State<MemberDatabase> {
  ...
  bool isEmpty(String linkedin) {
    if (linkedin == null || linkedin.trim() == "") return true;
    return false;
  }
                    ...
                    if (snapshot.hasError) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return members[index].name != null
                              ? ExpansionTile(
                                  title: AutoSizeText(
                                    members[index].name,
                                    style: TextStyle(
                                  ...
                                  children: [
                                    members[index].email != null &&
                                            members[index].email.trim() != ""
                                        ? ListTile(
                                            title: CustomToolTip(
                                        ...
                                        : Container(),
                                    members[index].organization != null &&
                                            members[index]
                                                    .organization
                                                    .trim() !=
                                                ""
                                        ...
                                        : Container(),
                                    members[index].position != null &&
                                            members[index].position.trim() != ""
                                        ? ListTile(
                                            title: AutoSizeText(
                                        ...
                                        : Container(),
                                    !isEmpty(members[index].linkedIn_link)
                                        ? ListTile(
  ...
  Widget build(BuildContext context) {
    ...
    return new GestureDetector(
      child: new Tooltip(
          ...
          child: AutoSizeText(
            text,
            style: TextStyle(fontSize: getWidth(16, 2)),
            maxLines: 1,
          )),
      onTap: () {
