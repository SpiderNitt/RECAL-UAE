      ...
      child: Scaffold(
        ...
        body: Padding(
          padding: EdgeInsets.symmetric(
              horizontal: getWidth(10, 1), vertical: getHeight(10, 1)),
          child: Material(
            color: Colors.white,
            elevation: 5,
            ...
            child: SingleChildScrollView(
              child: Padding(
                padding: EdgeInsets.symmetric(
                    vertical: getHeight(20, 1), horizontal: getWidth(20, 1)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Center(
                        child: Image.asset("assets/images/open_positions.png",
                            height: getWidth(100, 1), width: getWidth(100, 1))),
                    SizedBox(
                    ...
                    positionModel.open_until != null
                        ? Row(
                            ...
                            children: [
                              ...
                              AutoSizeText(
                                "Open Until: ${positionModel.open_until}",
                                style: TextStyle(
                                    color:
                                        ColorGlobal.textColor.withOpacity(0.8),
  ...
  Widget build(BuildContext context) {
    ...
    return new GestureDetector(
      child: AutoSizeText(
        text,
        style:
            TextStyle(color: ColorGlobal.textColor, fontSize: getWidth(17, 1)),
        maxLines: 2,
      ),
      onTap: () {
