    ...
    await http.post(
      ...
      if (_response.statusCode == 200) {
        ...
        if (responseBody.status_code == 200) {
          ...
          await http
              .get(uri, headers: {'Cookie': cookie}).then((_response) async {
            print(_response.statusCode);
            print(_response.body);
            if (_response.statusCode == 200) {
              ResponseBody responseBody =
              ...
              if (responseBody.status_code == 200) {
                User recal_user = User.fromProfile(
                    json.decode(json.encode(responseBody.data)));
              ...
              print("Server error");
              _userDialog(
                  "Server error, could not save details", "Try again", 0);
            }
          }).catchError((error) {
            print(error);
...
class _DropDownState extends State<DropDown> {
  ...
  List<int> getYears() {
    ...
    for (var i = year; i >= 1964; i--) all.add(i);
    return all;
  }
